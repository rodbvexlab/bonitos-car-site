...
import { SERVICES_PESADOS, STATS_PESADOS, PROCESS_STEPS, LOGOS_PESADOS, WA_LINKS } from '../lib/data'
    ...
    <motion.div variants={pageVariants} initial="initial" animate="animate" exit="exit" className="bg-void min-h-screen">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <motion.div
          ...
          style={{
            backgroundImage: "url('/assets/hero-pesados-desktop.webp')",
            y: bgY,
            scale: bgScale,
          }}
        />
        ...
        <div className="container relative z-10 pt-28 pb-24 md:pt-36 md:pb-32">
          <motion.div variants={heroText} initial="hidden" animate="visible" className="max-w-2xl">
            <motion.span variants={heroLine} className="label-red mb-6 block">
              Linha Estrutural — Caminhões e Frotas
            </motion.span>
            ...
            <motion.p variants={heroLine} className="font-body text-base md:text-lg text-text-2 max-w-lg leading-relaxed mb-10">
              Funilaria industrial, pintura em estufa e restauração completa de cabine para caminhões, carretas e frota comercial. Execução técnica com garantia por escrito.
            </motion.p>
            <motion.div variants={heroLine} className="flex flex-wrap gap-4">
              <Link to="/orcamento?cat=pesados" className="btn-primary">
                Solicitar Avaliação
              </Link>
              <a href={WA_LINKS.pesados} target="_blank" rel="noopener noreferrer" className="btn-ghost">
      ...
      <section className="border-y border-white/5 bg-surface py-5">
        <div className="container">
          <div className="flex flex-wrap justify-center gap-6 md:gap-12">
            {['Avaliação Presencial Gratuita', 'Prazo Cumprido na Entrega', 'Garantia por Escrito', 'Atendimento a Frotas'].map((item) => (
      ...
      {/* ── STATS — ghost text "PESADOS" behind numbers ── */}
      <section
        ...
        <div className="container">
          <FadeIn className="mb-12 md:mb-16">
            ...
            <p className="text-text-2 font-body max-w-lg">
              Estrutura completa para recuperação de veículos pesados com equipamentos de precisão industrial.
            </p>
          </FadeIn>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {SERVICES_PESADOS.map((svc, i) => (
              <ServiceCard
                key={svc.title}
                title={svc.title}
      ...
      <section className="section section-grain bg-surface">
        <div className="container">
          <FadeIn className="mb-12 md:mb-16">
            ...
            <p className="text-text-2 font-body max-w-lg">Casos reais executados pela nossa equipe. Arraste para comparar.</p>
          </FadeIn>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <FadeIn delay={0.1} direction="left">
              <p className="label mb-4 pl-1">Caso 01 — Scania</p>
              <BeforeAfterSlider
                before="/assets/pesados_before_scania_blur-desktop.webp"
                after="/assets/pesados_after_scania_blur-desktop.webp"
                className="h-[300px] md:h-[380px]"
              />
            </FadeIn>
            <FadeIn delay={0.2} direction="right">
              <p className="label mb-4 pl-1">Caso 02 — Sprinter</p>
              <BeforeAfterSlider
                before="/assets/pesados_before_sprinter.webp"
                after="/assets/pesados_after_sprinter.webp"
                className="h-[300px] md:h-[380px]"
              />
            </FadeIn>
          </div>
      ...
      <PartnersMarquee
        ...
        subtitle="Equipamentos e peças certificados. Atendimento para as principais marcas da linha pesada."
      />
      ...
      {/* ── CTA ── */}
      <CTASection
        title="Seu caminhão merece o melhor reparo."
        subtitle="Avaliação presencial na unidade, orçamento detalhado e execução com garantia por escrito."
        waLink={WA_LINKS.pesados}
      />
